...
- [canvasstr.org](https://canvasstr.org), yet another specialized client that uses the generic catallax protocol for a specific goal: people get paid to help curate decentralized lists, tag nostr profiles and notes, and build the lexiconomy
