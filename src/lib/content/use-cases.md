...
**! Crowdfunding is now implemented on the reference client!**
...
**! Crowdfunding + curation is available at [Grantless.org](https://grantless.org)**
...
Goes well with the Crowdfunding approach above as a strategy for funding open source.
